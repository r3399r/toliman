...
import B2C1S3 from './pages/lecture/book2/B2C1S3';
...
import B2C4S1 from './pages/lecture/book2/B2C4S1';
import B2C4S2 from './pages/lecture/book2/B2C4S2';
...
const AppRoutes = () => (
  <Routes>
    ...
    <Route path="/toliman/lecture/b2c1s3" element={<B2C1S3 />} />
    ...
    <Route path="/toliman/lecture/b2c4s1" element={<B2C4S1 />} />
    <Route path="/toliman/lecture/b2c4s2" element={<B2C4S2 />} />
