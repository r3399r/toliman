...
const Linear = () => {
  return (
    <MathJax>
      ...
      <Page pageNum={7}>
        <Example num={7} ids={['181cd3ed6d1', '181cd3fd7bf']} showAnswer={false} />
        <Example num={8} ids={['181cd40412b', '181cd40cf18']} showAnswer={false} />
      </Page>
      <Page pageNum={8}>
        <Example num={9} ids={['181cd423ce2', '181cd431153']} showAnswer={false} />
      ...
      <Page pageNum={10}>
        ...
        <Example num={14} ids={['181cd5e9291', '181cd5f56b9']} showAnswer={false} />
      </Page>
    </MathJax>
  );
};
