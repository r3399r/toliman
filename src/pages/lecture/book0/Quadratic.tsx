...
const Quadratic = () => {
  return (
    <MathJax>
      ...
      <Page pageNum={17}>
        <Example num={3} ids={['181d4740b7f', '181d4753b03']} showAnswer={false} height="3.2cm" />
        <Example num={4} ids={['181d4766aa6', '181d476e221']} showAnswer={false} height="3.2cm" />
        <Example num={5} ids={['181d477d55b', '181d478d7db']} showAnswer={false} height="3cm" />
      </Page>
      <Page pageNum={18}>
      ...
      <Page pageNum={20}>
        ...
        <Example num={11} ids={['181d61ff798', '181d6207b42']} showAnswer={false} />
      </Page>
    </MathJax>
  );
};
