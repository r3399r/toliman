  ...
  <div>
    <Page pageNum={16}>
      ...
      <Concept num={1} title="三角函數的圖形">
        ...
        <div>{'週期為　　，振幅為　　。'}</div>
        <div className={style.conceptHead}>餘弦函數的圖形</div>
        <div>{'餘弦函數 $y=\\cos x$'}</div>
        <div>
          {
    ...
    <Page pageNum={17}>
      <Concept num={1} title="三角函數的圖形">
        ...
        <div>{'週期為　　，振幅為　　。'}</div>
        <div className={style.conceptHead}>正切函數的圖形</div>
        <div>{'正切函數 $y=\\tan x$'}</div>
        <div>
          {
    ...
    <Page pageNum={18}>
      <Example num={1} ids={['17ba72f600a', '17ba731bf10']} height="11cm" />
      <Concept num={2} title="三角函數週期的變化">
        ...
        <div>
          ...
          <br />
          {
            '(2) 左右伸縮會改變週期，若 $f(x)$ 為週期函數且週期為 $p$，則 $y=f(ax+b)$ 仍為週期函數且週期變為 $\\dfrac{p}{|a|}$。'
          }
        </div>
      </Concept>
    </Page>
    ...
    <Page pageNum={21}>
      <Example num={6} ids={['17ba974214a', '17ba9770dbc']} height="20cm" />
    </Page>
    <Page pageNum={22}>
      ...
      <Example num={7} ids={['17ba9801b03', '17ba9835d86']} height="12cm" />
    </Page>
    <Page pageNum={23}>
    ...
    <Page pageNum={24}>
      <Example num={10} ids={['17ba9e804af', '17ba9e94d70']} height="20cm" />
    </Page>
    <Page pageNum={25}>
      <Example num={11} ids={['17ba9ed75d6', '17ba9f3dfa7']} height="20cm" />
    </Page>
    <Page pageNum={26}>
      <Example num={12} ids={['17ba9f5f6d0', '17ba9f8acb8']} height="20cm" />
    </Page>
    <Page pageNum={27}>
      <Example num={13} ids={['17ba9facfa6', '17ba9fc79fa']} height="20cm" />
    </Page>
  </div>
);
