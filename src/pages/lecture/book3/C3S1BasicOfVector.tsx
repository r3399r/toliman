  ...
  <div>
    <Page pageNum={1}>
      ...
      <Concept num={1} title="向量的定義及表示法">
        ...
        <div>{'相異兩點 $A$、$B$，以 $A$ 為起點、$B$ 為終點畫一個箭頭，此有向線段記為'}</div>
        <br />
        ...
        <div>
          若一個向量之起點與終點為同一點，規定此向量為零向量，記為　　　，大小為
          $0$，可為任意方向，零向量不可寫成數字 0。
        </div>
        <br />
      ...
      <Example num={1} ids={['17c3ff7a1a5', '17c3ff879b5']} height="6cm" />
    </Page>
    <Page pageNum={2}>
    ...
    <Page pageNum={3}>
      ...
      <Example num={4} ids={['17c3d243d52', '17c3d26a079']} height="8cm" />
    </Page>
    <Page pageNum={4}>
      <Example num={5} ids={['17c3d24d200', '17c3c395cde']} />
      <Concept num={3} title="向量的係數積與平行向量">
        <div className={style.conceptHead}>係數積</div>
        <div>{'給向量 $\\vector a$ 與實數 $r$，向量的係數積 $r\\vector a$ 如下：'}</div>
        <div>
          {'(1) $r>0$ 時，$r\\vector a$ 與 $\\vector a$ 同向，大小為 $\\vector a$ 的 $r$ 倍'}
        </div>
        <div>
          {'(2) $r<0$ 時，$r\\vector a$ 與 $\\vector a$ 反向，大小為 $\\vector a$ 的 $|r|$ 倍'}
        </div>
        <br />
        ...
        <div>
          ...
          <br />
          {'(3) $r(s\\vector a)=(rs)\\vector a$。如：$3(2\\vector a)=6\\vector a$'}
        </div>
        <br />
    ...
    <Page pageNum={9}>
      <Concept num={4} title="線性組合、分點公式與共線定理">
        ...
        <div>
          {
            '$P$ 點在 $\\overline{AB}$ 上，線段比例為 $\\overline{AP}:\\overline{BP}=m:n$，$O$ 為任意一點，則 $\\xvector{OP}=\\dfrac m{m+n}\\xvector{OA}+\\dfrac n{m+n}\\xvector{OB}$。注意，其係數和為 1。'
          }
        </div>
        <br />
        <br />
    ...
    <Page pageNum={12}>
      <Example num={18} ids={['17c5e2d8d18', '17c5ff6ee9c']} height="20cm" />
    </Page>
    <Page pageNum={13}>
    ...
    <Page pageNum={14}>
      <Example num={21} ids={['17c5bcac6bb', '17c5bcf51b4']} height="20cm" />
    </Page>
    <Page pageNum={15}>
    ...
    <Page pageNum={18}>
      <Example num={26} ids={['17c5fdff0c5', '17c5ff32ef2']} height="6cm" />
      <Example num={27} ids={['17c5fea4983', '17c5ff9c118']} height="9cm" />
    </Page>
    <Page pageNum={19}>
      <Example num={28} ids={['17c5ffd658c', '17c5fef7805']} height="20cm" />
    </Page>
  </div>
);
