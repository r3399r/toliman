  ...
  <div>
    <Page pageNum={20}>
      ...
      <Concept num={1} title="向量內積的定義與性質">
        ...
        <div>{'向量 $\\vector a$ 與 $\\vector b$ 的夾角為 $\\theta$，定義兩項量的內積為：'}</div>
        <div>{'(1) 夾角 $\\theta$ 為兩向量 $\\vector a$ 與 $\\vector b$ 共起點之夾角'}</div>
        <div>
          {
    ...
    <Page pageNum={24}>
      <Example num={7} ids={['17c923c9fee', '17c92607d70']} height="9.5cm" />
    ...
    <Page pageNum={28}>
      ...
      <Example num={14} ids={['17c6fdc3a65', '17c6fe8418e']} height="9.5cm" />
    </Page>
    <Page pageNum={29}>
      <Example num={15} ids={['17c6fe02cb9', '17c6fe40782']} />
      <Concept num={4} title="向量內積的應用－柯西不等式">
    ...
    <Page pageNum={32}>
      <Example num={19} ids={['17cbf3b2a7d', '17cbf3df5b9']} height="20cm" />
    </Page>
    <Page pageNum={33}>
      <Example num={20} ids={['17cbf396729', '17cbf3bea31']} height="20cm" />
    </Page>
  </div>
);
