...
const C2S1Derivative = () => (
  <div>
    ...
    <Page pageNum={5}>
      <Example num={5} ids={['17c91bb4a4b', '17c91bd468e']} height="6.2cm" />
      <Example num={6} ids={['17c91bc76bd', '17c91be0266']} height="7cm" />
      <Example num={7} ids={['17c91bce4f5', '17c91bebd27']} height="7cm" />
    </Page>
    <Page pageNum={6}>
    ...
    <Page pageNum={8}>
      <Example num={12} ids={['17c91ce7cd0', '17c91cf64d3']} height="22.5cm" />
    </Page>
  </div>
);
