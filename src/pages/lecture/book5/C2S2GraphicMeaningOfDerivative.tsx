    ...
    <div>
      <Page pageNum={9}>
        ...
        <Concept num={1} title="函數的增減與極值">
          ...
          />
          <Textarea2MathJax
            text={'(3) 若 $f(a)$ 在定義域中是最大的，則 $f(x)$ 在 $x=a$ 有最大值 $f(a)$'}
          />
          <Textarea2MathJax
            text={'(4) 若 $f(a)$ 在定義域中是最小的，則 $f(x)$ 在 $x=a$ 有最小值 $f(a)$\n　\n'}
          />
      ...
      <Page pageNum={12}>
        <Example num={5} ids={['17c91d74236', '17c94b815cd']} height="13cm" />
        <Concept num={2} title="凹口方向與反曲點">
          ...
          <Textarea2MathJax
            text={"(2) 虎口朝下稱為「凹向下」，因斜率遞減，滿足 $f''(x)<0$\n　\n　\n"}
          />
