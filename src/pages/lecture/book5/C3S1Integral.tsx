...
const C3S1Integral = () => {
  return (
    <div>
      ...
      <Example num={1} ids={['17c96241d2e', '17c9625c489']} />
      <Concept num={2} title="定積分">
        ...
        <Textarea2MathJax
          text={
            '在 $[a,b]$ 的範圍內，若 $f(x)\\ge0$，則定積分 $\\displaystyle\\int_a^bf(x)\\dd x$ 表示在 $a$ 到 $b$ 的範圍內，$f(x)$ 與 $x$ 軸所圍成的曲線下面積。若 $f(x)<0$，則定積分為負值，去掉負號才是面積。'
          }
        />
      ...
      <Example num={2} ids={['17c96288a36', '17c96280656']} />
      ...
      <Example num={7} ids={['17c962efc08', '17c962f51e7']} />
