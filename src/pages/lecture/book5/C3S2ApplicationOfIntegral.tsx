    ...
    <div>
      ...
      <Page pageNum={26}>
        <Concept num={2} title="旋轉體體積">
          ...
          <Textarea2MathJax
            text={
              '把函數圖形 $y=f(x)$ 在第一象限與 $x$ 軸所圍成的區域分成 $n$ 等分後，細長條繞 $x$ 軸旋轉會得到一個薄圓盤，將所有薄圓盤的體積相加，再讓 $n$ 趨近於無限大，就是該區域的旋轉體體積，以積分寫成 $\\displaystyle\\int_a^b\\pi y^2\\dd x=\\int_a^b\\pi[f(x)]^2\\dd x$。'
            }
          />
        </Concept>
        <Example num={4} ids={['17c9e0d44f6', '17ca0723a53']} height="18cm" />
      </Page>
      <Page pageNum={27}>
        <Example num={5} ids={['17ca0717e33', '17ca07372c1']} height="14.7cm" />
