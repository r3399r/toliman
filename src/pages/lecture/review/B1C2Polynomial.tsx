    ...
    <div>
      ...
      <Page pageNum={13}>
        ...
        <Concept num={8} title="二次方程式的根">
          <Textarea2MathJax
            text={
              '二次方程式 $ax^2+bx+c=0$ 必有兩根，可能為兩相異實根、重根、兩虛根\n公式解：\n　\n　\n　\n根與係數：若兩根為 $\\alpha$、$\\beta$，則 $\\begin{cases}\\alpha+\\beta=\\\\\\alpha\\beta=\\end{cases}$'
            }
          />
        </Concept>
      </Page>
      <Page pageNum={14}>
        ...
        <Concept num={10} title="二次函數">
          ...
          <Textarea2MathJax
            text={
              '(2) $y=ax^2+bx+c$ 配方後可得到 $y=a\\left(x+\\frac{b}{2a}\\right)^2+\\frac{4ac-b^2}{4a}$，得頂點坐標為 $\\left(-\\frac{b}{2a},\\frac{4ac-b^2}{4a}\\right)$，也就是說，當 $x=$　　　時，二次函數有最大值或最小值。'
            }
          />
          <Textarea2MathJax
            text={
      ...
      <Page pageNum={16}>
        <Concept num={12} title="高次多項式" height="12cm">
          <Textarea2MathJax
            text={
              '(1) $n$ 次多項式會有至多 $n-1$ 個水平切線，水平切線分開則有清楚的極大值與極小值；水平切線在同一處或無則不會產生極大值與極小值。'
            }
          />
          <Textarea2MathJax
            text={
