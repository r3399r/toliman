...
const B1C2Polynomial = () => {
  return (
    <div>
      <div className={style.head}>多項式</div>
      ...
      <Exercise ids={['17a17faa323', '17a17fb7134']} />
      <Concept num={3} title="多項式的除法原理">
        <Textarea2MathJax className={style.note} text={'被除=除x商+餘，除的次數>餘的次數'} />
      </Concept>
      <Exercise ids={['17a17fea46a', '17a17ffc39c']} />
      ...
      <Exercise ids={['17a18286398', '17a182b5deb']} />
      <Concept num={8} title="二次方程式的根">
        <Textarea2MathJax
          text={
            '二次方程式 $$ax^2+bx+c=0$$ 必有兩根，可能為兩相異實根、重根、兩虛根，公式解：\n根與係數：若二次方程式之兩根為 $$\\alpha$$、$$\\beta$$，則'
          }
        />
        <div className={style.note}>補公式解及根與係數及推導</div>
      </Concept>
      ...
      <Exercise ids={['17a19a05422', '17a19a1410c']} />
      <Concept num={11} title="三次函數">
        <Textarea2MathJax
          text={
        ...
        />
        <div className={style.note}>切四格畫四種圖</div>
      </Concept>
      <Exercise ids={['17a19a9301f', '17a19abbcc7']} />
      <Concept num={12} title="高次多項式">
        <Textarea2MathJax
          text={
        ...
        />
        <div className={style.note}>畫各種例子</div>
      </Concept>
      <Concept num={13} title="多項式不等式">
        <Textarea2MathJax
          text={
            '先使一邊為 $$0$$，再因式分解，並作出函數的略圖，標明函數值正負的分界點，即可解出不等式。'
          }
        />
      </Concept>
      ...
      <Example num={6} ids={['1798f91a336', '1798f91a336']} />
    </div>
  );
};
