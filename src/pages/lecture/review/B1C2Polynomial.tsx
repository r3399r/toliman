    ...
    <Page pageNum={12}>
      ...
      <Concept num={1} title="多項式的基本概念">
        <div>
          ...
          <br />
          {
            '(2) 多項式：$a_nx^n+a_{n-1}x^{n-1}+\\cdots+a_1x+a_0$，僅由 $x^k$ 組成，$a_k$ 稱為 $k$ 次項係數。'
          }
          <br />
          {
            '(3) 多項式的次數：以最高次且非零係數的項為準，$f(x)$ 的次數為 $n$，記為 $\\deg f(x)=n$。'
          }
          <br />
          {'(4) 各項係數和：即 $f(1)$。'}
        </div>
    ...
    <Page pageNum={15}>
      <Concept num={7} title="多項式的假設">
        <div>
          ...
          <br />
          {'(5) 結合 (1) 與 (4)：多項式可任意假設，只要符合次數即可，如 $a(x^2+bx+c)+dx+e$'}
        </div>
      </Concept>
      <Exercise ids={['17a18286398', '18155dc8999', '17a182b5deb', '18155df085c']} height="8.1cm" />
    </Page>
    <Page pageNum={16}>
