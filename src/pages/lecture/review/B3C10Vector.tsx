  ...
  <div>
    <Page pageNum={22}>
      ...
      <Concept num={1} title="向量定義與坐標表示法">
        ...
        />
        <Textarea2MathJax text={'(2) 向量有大小及方向，且可平移，只要同向且等長的兩向量即為相等'} />
        <Textarea2MathJax
          text={
    ...
    <Page pageNum={23}>
      ...
      <Concept num={3} title="向量的係數積">
        ...
        />
        <Textarea2MathJax
          text={'(2) 若 $\\vector{a}=(x,y)$，$r\\in\\mathbb{R}$，則 $r\\vector{a}=r(x,y)=(rx,ry)$'}
        />
        <Textarea2MathJax
          text={
    ...
    <Page pageNum={28}>
      <Concept num={11} title="三角形的四心 (數A)">
        ...
        <Textarea2MathJax text={'(2) $G$ 把中線分為　　　　的兩段，分割成六個等面積的小三角形'} />
        <Textarea2MathJax
