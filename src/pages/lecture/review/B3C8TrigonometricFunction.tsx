...
const B3C8TrigonometricFunction = () => {
  return (
    <div>
      ...
      <Concept num={4} title="二倍角公式">
        <Textarea2MathJax
          text={'$$\\sin$$ 的二倍角：$$\\sin2\\theta=2\\sin\\theta\\cos\\theta$$'}
        />
        <Textarea2MathJax
      ...
      <Concept num={5} title="半角公式">
        <Textarea2MathJax text={'半角公式可由 $$\\cos$$ 的二倍角公式推得。'} />
      </Concept>
      <Exercise ids={['17b7392533f', '17b73936315']} />
      <Concept num={6} title="三倍角公式">
        <Textarea2MathJax
      ...
      <Exercise ids={['17b7395c7e2', '17b7396db1b']} />
      ...
      <Exercise ids={['17b739bf1ba', '17b739d3ece']} />
      <Concept num={8} title="函數圖形的變化">
        <Textarea2MathJax
          text={
        ...
        <Textarea2MathJax
          text={
            '(3) $$f(x)$$ 的圖形以 $$x$$ 軸為基準，上下伸縮為 $$k$$ 倍，即為 $$y=k\\cdot f(x)$$ 的圖形'
          }
        />
        <Textarea2MathJax
          text={
      ...
      <Exercise ids={['17b73a6f1c5', '17b73a9657d']} />
      <Concept num={9} title="正餘弦疊合">
        <Textarea2MathJax
          text={
      ...
      <Exercise ids={['17b741d382b', '17b7420b612']} />
      <Example num={1} ids={['17b742931cf', '17b742d3338']} />
      <Example num={2} ids={['17b7439275c', '17b743be7ea']} />
      <Example num={3} ids={['17b743f2946', '17b74415bfb']} />
      <Example num={4} ids={['17b7e1d24b8', '17b7e2314d6']} />
      <Example num={5} ids={['17b7e251b1f', '17b7e281805']} />
      <Example num={6} ids={['17b7e3099e8', '17b7e33f865']} />
      <Example num={7} ids={['17b7e3e015b', '17b7e414060']} />
      <Example num={8} ids={['17b7e45604e', '17b7e4c391e']} />
      <Example num={9} ids={['17b7e4f1e51', '17b7e5131d7']} />
    </div>
  );
};
