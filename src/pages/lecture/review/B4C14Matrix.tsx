    ...
    <div>
      ...
      <Page pageNum={28}>
        <Concept num={5} title="二階反方陣">
          <Textarea2MathJax
            text={
              '設方陣 $A=\\begin{bmatrix}p&q\\\\r&s\\end{bmatrix}$，規定 $\\det(A)=\\begin{vmatrix}p&q\\\\r&s\\end{vmatrix}$，若 $\\det(A)\\ne0$，則 $A$ 有乘法反方陣 $A^{-1}=\\frac1{\\det(A)}\\begin{bmatrix}s&-q\\\\-r&p\\end{bmatrix}$，滿足 $AA^{-1}=A^{-1}A=I_2=\\begin{bmatrix}1&0\\\\0&1\\end{bmatrix}$，稱 $I_2$ 為單位方陣。'
            }
          />
        </Concept>
      ...
      <Page pageNum={31}>
        <Example num={1} ids={['17ce8eb133f', '17ce8edc471']} height="23cm" />
      </Page>
      <Page pageNum={32}>
