...
const B4C14Matrix = () => (
  <div>
    <Page pageNum={26}>
      ...
      <Exercise ids={['17ce40ae751', '17ce40c83ce']} height="6.5cm" />
    </Page>
    <Page pageNum={27}>
      ...
      <Exercise ids={['17ce40d9768', '17ce40fb208']} height="7cm" />
      ...
      <Exercise ids={['17ce410b897', '17ce412dcb2']} height="9cm" />
    </Page>
    <Page pageNum={28}>
      <Concept num={5} title="二階反方陣">
        <div>
          {
            '設方陣 $A=\\begin{bmatrix}p&q\\\\r&s\\end{bmatrix}$，規定 $\\det(A)=\\begin{vmatrix}p&q\\\\r&s\\end{vmatrix}$，若 $\\det(A)\\ne0$，則 $A$ 有乘法反方陣 $A^{-1}=\\dfrac1{\\det(A)}\\begin{bmatrix}s&-q\\\\-r&p\\end{bmatrix}$，滿足 $AA^{-1}=A^{-1}A=I_2=\\begin{bmatrix}1&0\\\\0&1\\end{bmatrix}$，稱 $I_2$ 為單位方陣。'
          }
        </div>
      </Concept>
      <Exercise ids={['17ce4148e4f', '17ce4154725']} height="6.6cm" />
      ...
      <Exercise ids={['17ce4166477', '17ce4181410']} height="7cm" />
    </Page>
    <Page pageNum={29}>
      ...
      <Exercise ids={['17ce41af316']} height="8cm" />
    ...
    <Page pageNum={30}>
      <Exercise ids={['17ce41d7778', '17ce41ee1d6']} height="8.7cm" />
      ...
      <Exercise ids={['17ce42281ee', '17ce4249a61']} height="7.4cm" />
    </Page>
    <Page pageNum={31}>
      <Example num={1} ids={['17ce8eb133f', '17ce8edc471']} height="20cm" />
    </Page>
    <Page pageNum={32}>
    ...
    <Page pageNum={34}>
      ...
      <Example num={7} ids={['17ce905c7c2', '17ce9083c89']} note=" (數A)" />
    </Page>
  </div>
);
